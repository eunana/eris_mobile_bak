 ...
 */
@Controller
public class ErisVideoController {

	/** EgovPropertyService */
	@Resource(name="propertiesService")
	protected EgovPropertyService propertyService;
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ErisVideoController.class);
	
	@IncludedMblInfo(name="동영상 촬영 서비스", order = 1000, gid = 10)
	@RequestMapping("/eris/dcr/erisVideoInfo.mdo")
	public String selectOpenApiInquiryHistoryList(@ModelAttribute("searchVO") OpenApiVO openApiVO, ModelMap model) throws Exception {
		...
		return "egovframework/eris/dcr/ErisVideoInfo";
	}
