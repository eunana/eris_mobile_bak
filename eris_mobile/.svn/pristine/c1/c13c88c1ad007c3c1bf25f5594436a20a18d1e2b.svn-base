...
<html>
	<head>
		...
		<!-- 다음맵 API -->
		<!-- <script type="text/javascript" src="http://apis.daum.net/maps/maps3.js?apikey=92daff5da3d268e64fb26b8bf87f1701"></script> -->
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=92daff5da3d268e64fb26b8bf87f1701"></script>
		...
		<script type="text/javascript" language="javascript" defer="defer">
	        ...
	        function successCallback(position) {
		        ...
		        if ($('#searchCondition').val() == "20") {
					zoomLevel = 1;
		        } else if ($('#searchCondition').val() == "30") {
					zoomLevel = 2;
				} else if ($('#searchCondition').val() == "50") {
					zoomLevel = 3;
				} else if ($('#searchCondition').val() == "100") {
					zoomLevel = 4;
				} else if ($('#searchCondition').val() == "250") {
					zoomLevel = 5;
				}
	                			...
	                			<div align="right">	
	                				<form id="searchVO" name="searchVO" method="post">
	                					...
	                					<select id="searchCondition" name="searchCondition" onchange="javascript:init();" data-role="none">
	                						<option value="20">20m 이내</option>
	                						<option value="30">30m 이내</option>
	                						<option value="50">50m 이내</option>
	                						<option value="100">100m 이내</option>
	                						<option value="250">250m 이내</option>
	               						</select></p>
	               					</form>
	               				</div>
	               			</div>
