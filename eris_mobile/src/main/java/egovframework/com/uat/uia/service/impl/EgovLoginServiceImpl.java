...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
    ...
    private EgovSndngMailRegistService sndngMailRegistService;
	 ...
	 /**
   	 ...
   	 * @exception Exception
   	 */
//	public Map actionLogin(Map param) throws Exception {
//
//		Map loginMap = null;
//		
//    	// 1. 입력한 비밀번호를 암호화한다.
//    	String enpassword = EgovFileScrty.encryptPassword(param.get("password").toString(), param.get("id").toString());
//    	param.put("password", enpassword);
//
//    	// 2. 아이디와 암호화된 비밀번호가 DB와 일치하는지 확인한다.
//    	loginMap = loginDAO.actionLogin(param);
//
//    	// 3. 결과를 리턴한다.
//    	if (loginMap != null && !"".equals(loginMap.get("id")) && !"".equals(loginMap.get("password"))) {
//    		return loginMap;
//    	} else {
