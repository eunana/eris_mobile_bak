...
public class LoginDAO extends EgovComAbstractDAO {
    ...
    public LoginVO actionLoginByEsntlId(LoginVO vo) throws Exception {
    	return (LoginVO)selectOne("loginDAO.ssoLoginByEsntlId", vo);
    }
    ...
    public LoginVO actionLogin(LoginVO vo) throws Exception {
    	return (LoginVO) this.selectOne("LoginDAO.selectActionLogin", vo);
    }
    ...
    public LoginVO actionCrtfctLogin(LoginVO vo) throws Exception {
    	...
    	return (LoginVO)selectOne("loginDAO.actionCrtfctLogin", vo);
    }
