...
/**
 * 개요
 * - KAKAO Map에 대한 Controller를 정의한다.
 *
 * 상세내용
 * - 
 * @author 고은아
 ...
 *   수정일      수정자           수정내용
 *  -------    --------    ---------------------------
 *   2020.08.05  고은아          최초 생성
 *
 * </pre>
 */
@Controller
public class ErisKakaoMapController {

	/** EgovPropertyService */
	@Resource(name="propertiesService")
	protected EgovPropertyService propertyService;
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ErisKakaoMapController.class);
	
	@IncludedMblInfo(name="음성녹음 서비스", order = 1002, gid = 10)
	@RequestMapping("/eris/dcr/erisKakaoMap.mdo")
	public String selectOpenApiInquiryHistoryList(@ModelAttribute("searchVO") OpenApiVO openApiVO, ModelMap model) throws Exception {
		...
		return "egovframework/eris/dcr/ErisKakaoMap";
	}
